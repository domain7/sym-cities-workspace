<?php
	...
	Class eventpublish_section extends Event{
		
		const ROOTELEMENT = 'publish-section';
		...
		public static function about(){
			return array(
					 ...
					 'version' => '1.0',
					 'release-date' => '2008-03-11T02:25:16+00:00',
					 'trigger-condition' => 'action[publish-section]');	
		}
        ...
        <pre class="XML"><code>&lt;publish-section result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/publish-section></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;publish-section result="error">
...
&lt;/publish-section></code></pre>
  ...
  &lt;/label>
  &lt;input name="fields[navigation]" type="hidden" value="..." />
...
&lt;/form></code></pre>
		...
		public function load(){			
			if(isset($_POST['action']['publish-section'])) return $this->__trigger();
		}
